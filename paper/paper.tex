...
According to the literature, the transportation cost of space elevator systems is estimated to be approximately 0.35 million USD per metric ton \cite{3,7}.i.e:
...
\[C_e=F_e+v_eM=\SI{1.725e11}{USD}+\SI{3.5e5}{USD/t}\times\SI{1e8}{t}=\SI{3.51725e13}{USD}\]
...
\[C_r=c_r\cdot\frac{M}{P_r}=7.3\times10^7\times\frac{10^8}{150}=\SI{4.867e13}{USD}\]
