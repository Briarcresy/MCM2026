...
\begin{abstract}
    ...
    To support the establishment and long-term development of a future lunar colony accommodating 100,000 inhabitants, this paper systematically compares the overall performance of different transport strategies in terms of construction efficiency, economic cost, and sustainability, focusing on large-scale material transport between Earth and the Moon. The study examines three scenarios: the Galaxy Port scheme relying solely on space elevator systems; the scheme utilising existing rocket bases exclusively; and a hybrid transport scheme combining both approaches.

Addressing the substantial material transport demands during lunar base construction, this study establishes time and cost models under transport capacity constraints. It integrates the conflicting objectives of minimising construction duration and total expenditure within a multi-objective mixed-integer linear programming framework. A normalised weighting method generates feasible solution sets and corresponding Pareto frontiers, quantitatively illustrating trade-offs between time and cost across varying transport proportions. Analysis indicates that compared to single-mode transport, hybrid strategies significantly shorten the overall construction period while introducing only limited incremental costs, demonstrating superior comprehensive performance across three proposed schemes.

To enhance the model's applicability under real-world conditions, this study further examines the robustness of the transport system under non-ideal operational scenarios, assessing the impact of reduced transport efficiency and delays on the overall scheme. Concurrently, addressing the water supply requirements for the long-term operation of the lunar colony, a system dynamics approach was employed to model annual water demand. This integrated considerations of water resource recycling efficiency and replenishment scheduling mechanisms, linking the associated transport requirements to the aforementioned optimisation model. Furthermore, comparative analyses of the environmental impacts of each scheme during long-term operation were conducted, accounting for the operational characteristics of different transport modes.

The comprehensive analysis demonstrates that the proposed modelling framework clearly reveals the inherent trade-offs between time, cost, and environmental impact across different Earth-Moon transportation schemes. The study concludes that integrating emerging space elevator technology with conventional rocket transportation offers a realistic pathway for the construction and sustained operation of future large-scale lunar colonies, balancing engineering feasibility, economic rationality, and long-term sustainability.
