...
Total mission weight: $W_0 = 1$ billion tons. Transport system parameters:
\begin{itemize}
...
\textbf{Elevator:}\\
$\alpha = 0.995$,\\
$\beta_1=2.2$, $\eta_1=30/365$ (short),\\
$\beta_2=1.5$, $\eta_2=10$ (long).
\end{minipage}\hfill
\begin{minipage}[t]{0.48\textwidth}
\textbf{Rocket:}\\
$\alpha = 0.9$,\\
$\beta_1=1.5$, $\eta_1=10/365$ (short),\\
$\beta_2=2.2$, $\eta_2=70/365$ (long).
\end{minipage}
